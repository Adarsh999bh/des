...
cipher=encrypt(l,gen_keys)
print ("\nEncrypted data:")
print(list(tostring(cipher))) 
   
result=decrypt(cipher,gen_keys)
print ("\nDecrypted data:")
print (list(tostring(result)))